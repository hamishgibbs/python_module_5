...
Another important part of data cleaning is testing the functions that you write. There are many resources cencerned with writing testable code, and frameworks for making unit testing easy. Here, we will do it without the use of any external libraries, and write a simple testing class. Refer to the modules on defining classes for the basics of instantiating a class. 
